...
func (gu *GroupUpdate) AddUserIDs(ids ...ulid.ID) *GroupUpdate {
...
func (gu *GroupUpdate) RemoveUserIDs(ids ...ulid.ID) *GroupUpdate {
...
// AddUserIDs adds the "users" edge to the User entity by IDs.
func (guo *GroupUpdateOne) AddUserIDs(ids ...ulid.ID) *GroupUpdateOne {
...
// RemoveUserIDs removes the "users" edge to User entities by IDs.
func (guo *GroupUpdateOne) RemoveUserIDs(ids ...ulid.ID) *GroupUpdateOne {
