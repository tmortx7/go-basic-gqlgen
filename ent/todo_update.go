...
func (tu *TodoUpdate) SetUserID(id ulid.ID) *TodoUpdate {
	tu.mutation.SetUserID(id)
	return tu
}

// SetNillableUserID sets the "user" edge to the User entity by ID if the given value is not nil.
func (tu *TodoUpdate) SetNillableUserID(id *ulid.ID) *TodoUpdate {
	if id != nil {
		tu = tu.SetUserID(*id)
	}
	return tu
...
// SetUserID sets the "user" edge to the User entity by ID.
func (tuo *TodoUpdateOne) SetUserID(id ulid.ID) *TodoUpdateOne {
	tuo.mutation.SetUserID(id)
	return tuo
}

// SetNillableUserID sets the "user" edge to the User entity by ID if the given value is not nil.
func (tuo *TodoUpdateOne) SetNillableUserID(id *ulid.ID) *TodoUpdateOne {
	if id != nil {
