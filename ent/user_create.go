...
func (uc *UserCreate) AddGroupIDs(ids ...ulid.ID) *UserCreate {
...
func (uc *UserCreate) AddFollowerIDs(ids ...ulid.ID) *UserCreate {
...
func (uc *UserCreate) AddFollowingIDs(ids ...ulid.ID) *UserCreate {
